...
import com.starzplay.movieapp.ui.home.ShowMediaList
import com.starzplay.movieapp.ui.home.SubtitleText
import com.starzplay.movieapp.ui.navgraph.MainNavGraph
import com.starzplay.movieapp.ui.theme.cornerRadius10
            ...
            Column {
                ...
                if (viewState.isSuccess) {
                    ...
                    if (personDetail.placeOfBirth?.isNotEmpty() == true)
                        PersonalInfo(stringResource(R.string.place_of_birth), personDetail.placeOfBirth!!)
                }
            }
        }
